import { TimeRow, resolveHourCycle, timeRowMinWidth, is12Hour, to12Hour, to24Hour } from './chunk-VSUMISTM.js';
import { CalendarBody, calendarGridWidth, resolveCalendarTranslations } from './chunk-UNMCKHMI.js';
import { calendarValueToDate, dateToCalendarValue, fromArkValues, toArkValues } from './chunk-TCWYBVIL.js';
import { mergeRefs } from './chunk-UVYTJQTJ.js';
import { controlOpenProps } from './chunk-5FDOOG4J.js';
import { inputSlot, inputControlClasses, shellGap, placeholderColor, inputShell } from './chunk-E2Y73U4Z.js';
import { FieldShell } from './chunk-FSC5UYO3.js';
import { Button } from './chunk-JCOCDKAC.js';
import { Popover, popoverClearTrigger, popoverPanel } from './chunk-GLWR5YCB.js';
...
var datePickerIconTrigger = cn(
  inputSlot,
  "cursor-pointer rounded-xs outline-none transition-colors hover:text-gray-light-700 dark:hover:text-gray-dark-200 disabled:cursor-not-allowed"
);
...
var DatePickerImpl = ({
  ...
  const showTypeableInput = Boolean(typeable) && !isRange && !withTime;
            ...
            /* @__PURE__ */ jsxs(
              DatePicker$1.Control,
              {
                ...
                className: cn(
                  ...
                  // A real `<input>` sits in the shell under `typeable` — leave the shell's own
                  // cursor at the browser default (text-cursor over the input, pointer over the
                  // icon trigger / clear button) instead of forcing pointer everywhere, matching
                  // `Combobox`'s Control (see `combobox.tsx`) rather than `Select`'s button-only one.
                  !showTypeableInput && "cursor-pointer",
                  classNames?.control
                ),
                children: [
                  showTypeableInput ? /* @__PURE__ */ jsxs("div", { className: cn("flex min-w-0 flex-1 items-center", shellGap[size]), children: [
                    /* @__PURE__ */ jsx(DatePicker$1.Trigger, { className: datePickerIconTrigger, children: startSlot ?? /* @__PURE__ */ jsx(CalendarIcon, {}) }),
                    /* @__PURE__ */ jsx(
                      DatePicker$1.Input,
                      {
...
//# sourceMappingURL=chunk-6IYVOPTS.js.map
//# sourceMappingURL=chunk-6IYVOPTS.js.map