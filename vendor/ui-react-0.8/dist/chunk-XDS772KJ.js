...
var dividerVariants = cva(["shrink-0"], {
  ...
  compoundVariants: [
    { orientation: "horizontal", size: "xs", class: "border-t" },
    { orientation: "horizontal", size: "sm", class: "border-t-2" },
    { orientation: "horizontal", size: "md", class: "border-t-[3px]" },
    { orientation: "horizontal", size: "lg", class: "border-t-4" },
    { orientation: "horizontal", size: "xl", class: "border-t-[5px]" },
    { orientation: "vertical", size: "xs", class: "border-s" },
    { orientation: "vertical", size: "sm", class: "border-s-2" },
    { orientation: "vertical", size: "md", class: "border-s-[3px]" },
    { orientation: "vertical", size: "lg", class: "border-s-4" },
...
export { Divider };
//# sourceMappingURL=chunk-XDS772KJ.js.map
//# sourceMappingURL=chunk-XDS772KJ.js.map