...
export { COLORS } from './chunk-JBVFWSRQ.js';
...
import { useEffect, useLayoutEffect, useState, useRef, useCallback, useSyncExternalStore, useMemo } from 'react';

// src/lib/sizes.ts
var SIZES = ["xs", "sm", "md", "lg", "xl"];
function useDisclosure(initialOpen = false, { onOpen, onClose } = {}) {
  ...
  return [open, { open: openHandler, close: closeHandler, toggle: toggleHandler }];
}
...
export { SIZES, useDisclosure, useIsomorphicLayoutEffect, useLocalStorage, useLogger, useMediaQuery, useTheme };
