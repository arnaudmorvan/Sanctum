import { inputSlot, inputShell, inputControlClasses } from './chunk-E2Y73U4Z.js';
import { scrollHighlightedIntoView, popoverChevron, popoverClearTrigger, popoverList, popoverContent, popoverIndicator, popoverOption, popoverGroupLabel, popoverEmpty } from './chunk-GLWR5YCB.js';
...
var Root = ({
  ...
  testId,
  ...rest
}) => /* @__PURE__ */ jsx(ComboboxStyleContext.Provider, { value: { size, variant }, children: /* @__PURE__ */ jsx(
  Combobox$1.Root,
  {
...
var Input = ({ className, testId, ...rest }) => /* @__PURE__ */ jsx(
  Combobox$1.Input,
  {
...
var Content = ({
  ...
  return /* @__PURE__ */ jsx(Portal, { children: /* @__PURE__ */ jsx(Combobox$1.Positioner, { children: /* @__PURE__ */ jsx(Combobox$1.Content, { className: cn(popoverContent, className), ...rest, children: /* @__PURE__ */ jsx(Combobox$1.List, { className: popoverList({ withPaddingTop }), children }) }) }) });
};
var Panel = ({
  className,
  children,
  ...
  return /* @__PURE__ */ jsx(Combobox$1.Content, { ...rest, children: /* @__PURE__ */ jsx(Combobox$1.List, { className: cn(popoverList({ withPaddingTop }), className), children }) });
};
...
export { Combobox };
//# sourceMappingURL=chunk-K6KBNUGD.js.map
//# sourceMappingURL=chunk-K6KBNUGD.js.map