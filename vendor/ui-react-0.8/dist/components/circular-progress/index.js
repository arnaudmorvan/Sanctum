...
var resolveDimension = (value, key, fallbackSize) => {
  if (typeof value === "number") return value;
  if (value != null) return CIRCULAR_DIMENSIONS[value][key];
  const fallback = typeof fallbackSize === "number" ? "md" : fallbackSize ?? "md";
  return CIRCULAR_DIMENSIONS[fallback][key];
};
...
var CircularProgress = ({
  ...
  return /* @__PURE__ */ jsxs(
    Progress.Root,
    {
      ...
      style: {
        "--size": `${resolveDimension(size, "size", size)}px`,
        "--thickness": `${resolveDimension(thickness, "thickness", size)}px`,
        ...style
      },
      ...rest,
      children: [
