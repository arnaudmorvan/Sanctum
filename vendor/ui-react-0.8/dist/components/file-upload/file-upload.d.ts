...
export declare const FileUpload: ({ value, onChange, accept, maxFiles, maxFileSize, directory, invalid, disabled, required, size, name, id, ref, label, description, error, withButton, hint, className, classNames, testId, }: FileUploadProps) => import("react").JSX.Element;
export {};
