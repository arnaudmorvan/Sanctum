...
export declare const MultiComboboxList: <const Data extends SelectData = SelectData>({ data, value: valueProp, defaultValue, onChange, renderItem, placeholder, empty, clearable, maxValues, hidePickedOptions, size, variant, disabled, readOnly, required, invalid, name, onBlur, ref, label, description, error, className, classNames, testId, }: MultiComboboxListProps<Data>) => import("react").JSX.Element;
export {};
