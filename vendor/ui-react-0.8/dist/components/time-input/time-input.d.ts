...
export declare const TimeInput: ({ value, defaultValue, onChange, format, hourCycle, minuteStep, withSeconds, placeholder, locale, translations, size, variant, disabled, readOnly, invalid, required, name, onBlur, ref, label, description, error, className, classNames, testId, }: TimeInputProps) => import("react").JSX.Element;
export {};
