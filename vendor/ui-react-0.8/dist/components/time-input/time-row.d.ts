...
export declare const TimeRow: ({ hour, minute, second, onHourChange, onMinuteChange, onSecondChange, period, onPeriodChange, hourCycle, minuteStep, withSeconds, placeholder, locale, translations, size, variant, disabled, readOnly, invalid, ref, onBlur, className, classNames, }: TimeRowProps) => import("react").JSX.Element;
export {};
