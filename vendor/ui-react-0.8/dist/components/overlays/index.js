"use client";
import { Modal } from '../../chunk-NJUTHLO7.js';
...
function ConfirmActions({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-6 flex items-center justify-end gap-2", children: [
    /* @__PURE__ */ jsx(Button, { variant: "light", color: "neutral", onClick: handleCancel, ...entry.cancelProps, children: entry.labels.cancel }),
