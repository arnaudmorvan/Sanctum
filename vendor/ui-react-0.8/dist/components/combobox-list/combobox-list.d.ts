...
export declare const ComboboxList: <const Data extends SelectData = SelectData>({ data, value: valueProp, defaultValue, onChange, renderItem, placeholder, empty, clearable, size, variant, disabled, readOnly, required, invalid, name, onBlur, ref, label, description, error, className, classNames, testId, }: ComboboxListProps<Data>) => import("react").JSX.Element;
export {};
