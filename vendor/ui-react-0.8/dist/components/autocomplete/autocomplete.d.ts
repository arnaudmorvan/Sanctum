...
export declare const Autocomplete: <const Data extends SelectData = SelectData>({ data, value, defaultValue, onChange, renderItem, placeholder, clearable, clearSectionMode, startSlot, endSlot, empty, size, variant, disabled, readOnly, required, invalid, name, onBlur, ref, label, description, error, className, classNames, testId, }: AutocompleteProps<Data>) => import("react").JSX.Element;
export {};
