...
export declare const InputBase: ({ variant, size, invalid, disabled, readOnly, pointer, startSlot, endSlot, children, className, classNames, testId, ...rest }: InputBaseProps) => import("react").JSX.Element;
...
export declare const Input: ({ variant, size, invalid, disabled, readOnly, pointer, startSlot, endSlot, className, classNames, testId, ...rest }: InputProps) => import("react").JSX.Element;
export {};
