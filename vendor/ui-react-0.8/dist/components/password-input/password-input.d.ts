...
export declare const PasswordInput: ({ value, defaultValue, onChange, name, placeholder, variant, size, invalid, disabled, readOnly, required, label, description, error, startSlot, id, ref, onBlur, className, classNames, testId, }: PasswordInputProps) => import("react").JSX.Element;
